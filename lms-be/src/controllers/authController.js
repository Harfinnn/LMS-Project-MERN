...
export const signUpAction = async (req, res) => {
  ...
  const midtransAuthString = process.env.MIDTRANS_AUTH_STRING; // Base64 dari SERVER_KEY:
  ...
  try {
    ...
    // Buat user baru (belum disave dulu)
    ...
    // Buat data transaksi (belum disave)
